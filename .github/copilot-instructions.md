...
- Use Hydrus's file-relationship system and duplicate-group king to select the best existing version during import, not structural tag matching or image-size heuristics. Keep alternates distinct.
